        ...
        submenu: [
          {
            ...
            submenu: [
              { label: "Sales", link: "/programs/Executive-Post-Graduate-Certificate-Programmes/sales" },
              { label: "Product Management", link: "/programs/Executive-Post-Graduate-Certificate-Programmes/product-management" },
              { label: "Cybersecurity", link: "/programs/Executive-Post-Graduate-Certificate-Programmes/cybersecurity" },
              { label: "Brand Management & Digital Marketing", link: "/programs/Executive-Post-Graduate-Certificate-Programmes/bm-dm" },
              { label: "Mobility & Sustainability", link: "/programs/Executive-Post-Graduate-Certificate-Programmes/mobility-sustainability" },
              { label: "Consulting", link: "/programs/Executive-Post-Graduate-Certificate-Programmes/consulting" },
              { label: "Banking & Finance", link: "/programs/Executive-Post-Graduate-Certificate-Programmes/banking-finance" },
              { label: "Business Analytics", link: "/programs/Executive-Post-Graduate-Certificate-Programmes/business-analytics" },
              { label: "Data Science & AI", link: "/programs/Executive-Post-Graduate-Certificate-Programmes/data-science" },
            ],
          },
          {
